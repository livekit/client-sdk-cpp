 ...
 * sufficient because the SessionManager still holds a reference.
 *
 * After release() (whether called explicitly or by the SessionManager on
 ...
 *
 * Usage:
 *   auto cam = session_manager.createVideoTrack("cam", 1280, 720,
