...
/// @brief Error code returned when publishing a local data track fails.
...
/// @brief Error code returned when pushing a frame to a local data track fails.
...
/// @brief Error details returned when pushing a frame to a local data track fails.
...
/// @brief Error code returned when subscribing to a remote data track fails.
...
/// @brief Error details returned when subscribing to a remote data track fails.
