...
Two headless executables — **RpcReceiver** and **RpcCaller** —
...
```bash
# Terminal 1
LIVEKIT_URL=wss://... LIVEKIT_TOKEN=<receiver-token> ./build-release/bin/RpcReceiver

# Terminal 2
LIVEKIT_URL=wss://... LIVEKIT_TOKEN=<caller-token>   ./build-release/bin/RpcCaller
```
