...
/*
 * Receiver for the bridge_rpc example.
 *
 ...
 *
 * Usage:
 *   BridgeRpcReceiver <ws-url> <token>
 *   LIVEKIT_URL=... LIVEKIT_TOKEN=... BridgeRpcReceiver
 *
...
int main(int argc, char *argv[]) {
  ...
  if (url.empty() || token.empty()) {
    std::cerr << "Usage: BridgeRpcReceiver <ws-url> <token>\n"
