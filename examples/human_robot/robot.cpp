...
int main(int argc, char *argv[]) {
  ...
  auto sim_audio =
      sm.createAudioTrack("robot-sim-audio", kSampleRate, kChannels,
                          livekit::TrackSource::SOURCE_SCREENSHARE_AUDIO);
  auto cam = sm.createVideoTrack("robot-cam", kWidth, kHeight,
                                 livekit::TrackSource::SOURCE_CAMERA);
  auto sim_cam = sm.createVideoTrack("robot-sim-frame", kSimWidth, kSimHeight,
